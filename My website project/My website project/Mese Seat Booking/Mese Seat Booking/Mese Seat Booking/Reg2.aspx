<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reg2.aspx.cs" Inherits="Mese_Seat_Booking_Reg2" %>
                    ...
                    <table>
                        <tr>
                            <td><p class="main_con_p">Name:</p>
                                <asp:TextBox class="tp" ID="main_p1" runat="server" placeholder="Enter your name" Font-Bold="True"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:Label runat="server" ID="submitsms" CssClass="list" Font-Bold="True" Font-Italic="True" Font-Names="Tahoma" Font-Size="16px" ForeColor="Red" Text="User Already Exists"></asp:Label>
