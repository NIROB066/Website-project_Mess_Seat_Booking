<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentAsthayee.aspx.cs" Inherits="Mese_Seat_Booking_StudentAsthayee" %>
    ...
    <form  runat="server">
      ...
      <section id="mainmenu">
          <div id="div0"><ul><li></li></ul></div>
           <div id="div1"><ul><li><a href="Student.aspx"><p class="cng1">Home</p></a></li></ul></div>
                ...
                <div id="booking">
                    ...
                    <section id="booking_section">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="Booking_button" runat="server" Text="Book" OnClick="Booking_button_Click" />
                                </td>
                            </tr>
                        </table>
                    </section>
