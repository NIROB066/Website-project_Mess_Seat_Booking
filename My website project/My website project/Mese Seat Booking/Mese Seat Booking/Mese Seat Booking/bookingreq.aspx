<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookingreq.aspx.cs" Inherits="Mese_Seat_Booking_bookingreq" %>
       ...
       <div id="mainpart">
           ...
           <section id="bodyportion1">
               <table>
                   <tr>
                       <td>
                               <p class="bodyfstclass1">Select Student id :</p>
                       </td>
                       <td>
                           <asp:DropDownList runat="server" ID="stdsec" CssClass="bodylevclass" Font-Bold="True" Font-Size="20px" Height="30px" Width="200px"></asp:DropDownList>
                       </td>
                       <td>
                            <asp:Button runat="server" ID="selectbutton" CssClass="bodylevclass" Text="Click it" Font-Bold="True" Font-Size="20px" Height="30px" Width="120px" OnClick="selectbutton_Click" />
                       </td>
                   </tr>
                   <tr>
                       <td>
                       ...
                       <td>
                           <asp:Label runat="server" ID="sbook" CssClass="bodylevclass" Font-Bold="True" Font-Names="Tahoma" Font-Size="22px" ForeColor="Black"></asp:Label>
                       </td>
                   ...
                   <tr>
                       <td>
                               <p class="bodyfstclass1">Wants to book :</p>
                       </td>
                       <td>
                   ...
                   <tr>
                           ...
                           <td>
                               <asp:Button runat="server"  ID="Accept" Font-Bold="True" Font-Size="18px" Font-Names="Tahoma" ForeColor="Red" Height="50px" Text="Accept Request" Width="150px" OnClick="Accept_Click" />
                           </td>
                       <td>
