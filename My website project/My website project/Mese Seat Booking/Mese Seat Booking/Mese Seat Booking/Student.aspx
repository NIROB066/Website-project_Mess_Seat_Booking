<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student.aspx.cs" Inherits="Mese_Seat_Booking_Student" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Student's Personal Information</title>
   ...
   <div id="maindiv">
      ...
      <section id="mainmenu">
          <div id="div0"><ul><li></li></ul></div>
           ...
           <div id="div2"><ul><li><p class="cng1">Mess List</p>
              <div class="problem_solving">
               <ul>
                   <asp:Repeater runat="server" DataSourceID="SqlDataSource1">
                       <ItemTemplate>
                           <li>
                               <a href="StudentAsthayee.aspx?messname=<%#Eval("userid") %>"> <asp:Label runat="server" ID="messnamelable" CssClass="cng1"  text='<%# Eval("mesename") %>'></asp:Label></a>
                           </li>
                       </ItemTemplate>
                   </asp:Repeater> 
           ...
           <section id="bodyportion">
               <table>
                   <tr>
                       ...
                       <td>
                               <asp:TextBox runat="server" CssClass="bodyfstclass2" ID="TextBoxdetails" Font-Bold="True" Font-Names="Tahoma" ForeColor="#FF3399" Height="50px" Width="400px" placeholder="Enter Your Name..." Font-Size="22px"></asp:TextBox>
                       </td>
                       <td>
                   ...
                   <tr>
                           <td>
                               <p class="bodyfstclass1">Booked rooms :</p>
                           </td>
                           <td>
                                <asp:TextBox runat="server" CssClass="bodyfstclass2" ID="TextBox6" Font-Bold="True" Font-Names="Tahoma" ForeColor="#FF3399" Height="50px" Width="400px" Font-Size="22px" ReadOnly="True"></asp:TextBox>
                           </td>
                       </tr>
                   <tr>
                           <td>
                               <p class="bodyfstclass1">Booked Messname :</p>
                           </td>
                           <td>
                                <asp:TextBox runat="server" CssClass="bodyfstclass2" ID="TextBox7" Font-Bold="True" Font-Names="Tahoma" ForeColor="#FF3399" Height="50px" Width="400px" Font-Size="22px" ReadOnly="True"></asp:TextBox>
                           </td>
                       </tr>
                   <tr>
                           <td>
