...
public partial class Mese_Seat_Booking_Reg2 : System.Web.UI.Page
{
    int temp;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(!IsPostBack)
        {
            main_p1.Text = Session["fstnames"].ToString();
            email.Text = Session["emails"].ToString();
            address.Text = Session["addresss"].ToString();
            con_num.Text = Session["phones"].ToString();
            Password1.Text = Session["passwords"].ToString();
        }
    }
