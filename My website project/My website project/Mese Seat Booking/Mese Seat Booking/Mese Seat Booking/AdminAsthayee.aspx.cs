...
public partial class Mese_Seat_Booking_AdminAsthayee : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Session["Asthayee"] = Request.QueryString["name3"] as String;
        }
        if (Request.QueryString["name3"] != null)
        {
            Session["useridfromajax"] = Request.QueryString["name3"] as String;
        }
